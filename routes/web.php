...
Route::group(['prefix' => 'image'], function () {
    ...
    Route::get('/detail/delete/{id}', 'ImageController@delete')->name('image.delete');
    Route::get('/detail/edit/{id}', 'ImageController@edit')->name('image.edit');
    Route::put('/detail/edit/update', 'ImageController@update')->name('image.update');
});
